...
const CreateEvent = () => {
    ...
    return (
        <div className='max-w-7xl mx-auto w-11/12 my-20'>
            ...
            <div className="max-w-lg mx-auto bg-white p-8 rounded-2xl shadow-lg mt-8 text-black">
                ...
                <form onSubmit={handleCreateEvent} className="space-y-4">
                    ...
                    {/* Description  */}
                    <textarea value={description} onChange={(e) => setDescription(e.target.value)} placeholder="Description" className="w-full border p-2 border-primary rounded" rows="3" required />
