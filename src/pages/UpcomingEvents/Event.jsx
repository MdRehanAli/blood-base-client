...
const Event = ({ event }) => {
    ...
    return (
        <div className='flex flex-col justify-between h-full shadow-2xl rounded-xl p-6 gap-1'>
            <img src={thumbnail} alt={title} className="w-full object-cover rounded-xl" />
            <h3 className="text-lg text-center font-semibold mt-4 text-red-700">{title}</h3>
